...
export class TreeSurveysController {
  ...
  @ApiResponse({ status: 201, description: 'Relevamiento registrado exitosamente', type: TreeSurveyResponseDto })
  ...
  @ApiResponse({ status: 403, description: 'Sin permisos para registrar relevamientos', type: ErrorResponseDto })
  ...
  @ApiResponse({ status: 401, description: 'Token JWT inválido o ausente', type: ErrorResponseDto })
  @ApiResponse({ status: 404, description: 'Árbol o relevamiento no encontrado', type: ErrorResponseDto })
  @ApiResponse({ status: 500, description: 'Error interno del servidor', type: ErrorResponseDto })
  async findOne(
    @Param('treeId', ParseUUIDPipe) treeId: string,

...
export class TreesService {
  ...
  private toResponseDto(tree: any): TreeResponseDto {
    return {
      ...
      lat: tree.lat === null ? null : Number(tree.lat),
      lng: tree.lng === null ? null : Number(tree.lng),
      heightM: tree.heightM === null ? null : Number(tree.heightM),
      diameterCm: tree.diameterCm === null ? null : Number(tree.diameterCm),
      active: tree.active,
